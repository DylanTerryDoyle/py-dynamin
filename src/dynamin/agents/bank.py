...
class Bank:
    ...
    def determine_capital(self, t: int) -> None:
        ...
        self.desired_capital_ratio[t] = self.min_capital_ratio + self.expected_loss_ratio[t]
    ...
    def determine_loan_interest(self, t: int) -> None:
        ...
        if self.desired_capital_ratio[t] >= self.capital_ratio[t] and self.loans[t] > 0:
    ...
    def compute_loan_supply(self, firm: 'ConsumptionFirm | CapitalFirm', t: int) -> float:
        ...
        if self.desired_capital_ratio[t] < self.capital_ratio[t] or self.loans[t] <= 0.001:
